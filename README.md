...
Instead of relying on static demographics, this model utilizes Balance Volatility. Inspired by GARCH models in financial time series, we detect cash-flow instability as an early warning signal of account closure.
...
Model Performance: AUC-ROC of 0.761, reflecting a realistic and robust performance under real-world noise levels (σ=0.25).
